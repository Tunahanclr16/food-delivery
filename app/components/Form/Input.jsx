    ...
    return (
        <div className='w-full'>
            <label htmlFor={name} className='relative block cursor-text'>
                ...
                <span className='absolute  top-0 left-0 px-4 text-sm flex h-full items-center peer-valid:h-7 peer-hover:top-722 transition-all duration-200 peer-valid:text-xs  text-gray-400'>{placeholder}</span>
            </label>
        </div>
    )
}
